...
void copy_array(int a[3][3],int b[3][3])//copia de b para a.
{
     int i,j;
     for(i=0;i<3;i++)
                     for(j=0;j<3;j++)
...
int check_zero(int a[3][3])//retorna de 1 se 0.
{
    int i,j,flag=1;
     for(i=0;i<3;i++)
     {                for(j=0;j<3;j++)
...
int is_goal(node *nd) //retorna 1 se o objetivo.
{
...
int main()
{
    ...
    printf("Digite o estagio objetivo: \n");
    for(i=0;i<3;i++)
                    for(j=0;j<3;j++)
                                    scanf("%d",&n->a[i][j]);
    ...
    printf("Digite o estagio atual: \n");
    for(i=0;i<3;i++)
                    for(j=0;j<3;j++)
                                    scanf("%d",&goal[i][j]);

    n->f=calc_heuristic(n);
    printf("\nA sequencia de estagios ate o objetivo e: \n",f_count);
    A_star(n);
    scanf("%d",&i);
    return 0;
}
